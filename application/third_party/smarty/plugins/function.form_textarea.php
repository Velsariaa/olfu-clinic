...
function smarty_function_form_textarea($params, &$template)
{
    ...
    $attr_value = $params['value'] ?? $tuple[$attr_name] ?? '';
    ...
    $input = HtmlElement::render('textarea.'.join('.', $input_class), $attributes, $attr_value);
