...
<div class="navbar navbar-dark navbar-expand-lg navbar-static border-bottom border-bottom-white border-opacity-10">
	<div class="container-fluid">
		...
		<div class="navbar-brand flex-1 flex-lg-0">
			<a href="{'home'|route}" class="d-inline-flex align-items-center">
				<img src="{$assets_url}/images/logo1.png" alt="" style="height: 2rem !important">
				{* <img src="{$assets_url}/images/logo_icon.svg" class="d-none d-sm-inline-block h-16px ms-3" alt=""> *}
			</a>
		</div>
					...
					<div class="row row-cols-1 row-cols-sm-2 g-0">
						<div class="col">
							<button type="button" class="dropdown-item text-wrap h-100 align-items-start border-end-sm border-bottom p-3">
								<div>
									<img src="{$assets_url}/images/demo/logos/1.svg" class="h-40px mb-2" alt="">
						...
						<div class="col">
							<button type="button" class="dropdown-item text-wrap h-100 align-items-start border-bottom p-3">
								<div>
									<img src="{$assets_url}/images/demo/logos/2.svg" class="h-40px mb-2" alt="">
						...
						<div class="col">
							<button type="button" class="dropdown-item text-wrap h-100 align-items-start border-end-sm border-bottom border-bottom-sm-0 rounded-bottom-start p-3">
								<div>
									<img src="{$assets_url}/images/demo/logos/3.svg" class="h-40px mb-2" alt="">
						...
						<div class="col">
							<button type="button" class="dropdown-item text-wrap h-100 align-items-start rounded-bottom-end p-3">
								<div>
									<img src="{$assets_url}/images/demo/logos/4.svg" class="h-40px mb-2" alt="">
				...
				<div class="form-control-feedback form-control-feedback-start flex-grow-1" data-color-theme="dark">
					...
					<div class="dropdown-menu w-100" data-color-theme="light">
						...
						<div class="dropdown-menu-scrollable-lg">
							...
							<div class="dropdown-item cursor-pointer">
								<div class="me-3">
									<img src="{$assets_url}/images/brands/adobe.svg" class="w-32px h-32px rounded-pill" alt="">
								</div>
							...
							<div class="dropdown-item cursor-pointer">
								<div class="me-3">
									<img src="{$assets_url}/images/brands/holiday-inn.svg" class="w-32px h-32px rounded-pill" alt="">
								</div>
							...
							<div class="dropdown-item cursor-pointer">
								<div class="me-3">
									<img src="{$assets_url}/images/brands/ing.svg" class="w-32px h-32px rounded-pill" alt="">
								</div>
			...
			<li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
				<a href="#" class="navbar-nav-link align-items-center rounded-pill p-1" data-bs-toggle="dropdown">
					<div class="status-indicator-container">
						<img src="{$assets_url}/images/uni-user.png" class="w-32px h-32px rounded-pill" alt="">
						<span class="status-indicator bg-success"></span>
					</div>
				...
				<div class="dropdown-menu dropdown-menu-end">
					...
					<a href="{'profile'|route}" class="dropdown-item">
						<i class="ph-user-circle me-2"></i>
						My Profile
					</a>
					<a href="{'logout'|route}" class="dropdown-item">
